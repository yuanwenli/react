...
import { Form, Comment, List, Tag, message, Popconfirm,Radio, Modal, Input, Select, Upload, Button } from 'antd';
      ...
      <div>
        ...
        >
          <Form >
            ...
            <Form.Item label="活动评价" {...formItemLayout}>
              {getFieldDecorator('EvaluateType', {
                ...
                <RadioGroup onChange={this.onChange} >
                    <Radio checked value="5">非常喜欢</Radio>
                    <Radio value="4">喜欢</Radio>
                    <Radio value="3">一般</Radio>
                    <Radio value="2">不喜欢</Radio>
                    <Radio value="1">非常不喜欢</Radio>
            ...
            <Form.Item label="是否被别人可见" {...formItemLayout}>
              {getFieldDecorator('IsDisplay', {
                ...
                <RadioGroup onChange={this.onChange}>
                    <Radio checked value="1">显示</Radio>
        ...
        {activityList && activity && activityList.list && activityList.list.length > 0 ? <List
          ...
          renderItem={item => (
            ...
            <Comment
              ...
              avatar={item.avatar}
              content={item.content||item.ClassContent}
